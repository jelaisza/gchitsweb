...
<body>
  ...
  if(isset($_POST['submit'])){
  	...
  	if($resultSet-> num_rows > 0){
        ...
        $accident= $rows['accident'];
        $accidentdate = $rows['accidentdate'];
        $e_name = $rows['e_name'];
        $e_relationship = $rows['e_relationship'];
        $e_address = $rows['e_address'];
        $e_contact= $rows['e_contact'];
...
<p>Accident Date: $accidentdate
<br>

<center><p>Person To be notified in Case of Accident</p></center>

<p>Name: $e_name
<br>

<p>Relationship: $e_relationship
<br>
