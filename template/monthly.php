...
if(isset($_POST['btn-save']))
{
 ...
 $m_name = $_POST['m_name'];
 $m_stockonhand = $_POST['m_stockonhand'];
 $m_delivery= $_POST['m_delivery'];
 $m_consumption = $_POST['m_consumption'];
 $m_balancetodate= $_POST['m_balancetodate'];
 // variables for input data

 // sql query for inserting data into database
 $sql_query = "INSERT INTO tbl_medicine(m_name,m_stockonhand,m_delivery,m_consumption,m_balancetodate)
 VALUES('$m_name','$m_stockonhand','$m_delivery','$m_consumption','$m_balancetodate')";
                                            ...
                                            <div class="card-content">
                                                <form method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <input type="text" name="m_stockonhand" class="form-control">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <input type="text" name="m_delivery" class="form-control">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <input type="text" name="m_consumption" class="form-control">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group label-floating">
                                                                <label class="control-label">Balance to Date</label>
                                                                <input type="text" name="m_balancetodate" class="form-control">
                                                            </div>
                                                        </div>
